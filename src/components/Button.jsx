...
const Button = () => {
  return (
    ...
    >
        Create account
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--iconoir" width="20px" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
